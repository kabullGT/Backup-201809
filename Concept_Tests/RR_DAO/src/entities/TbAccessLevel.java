...
public class TbAccessLevel implements Serializable {
    ...
    @Column(name = "dsc")
    private String dsc;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "tbAccessLevel")
    private Collection<TbUserAccessLevel> tbUserAccessLevelCollection;
    ...
    @XmlTransient
    public Collection<TbUserAccessLevel> getTbUserAccessLevelCollection() {
        return tbUserAccessLevelCollection;
    }

    public void setTbUserAccessLevelCollection(Collection<TbUserAccessLevel> tbUserAccessLevelCollection) {
        this.tbUserAccessLevelCollection = tbUserAccessLevelCollection;
    }
    ...
    public String toString() {
        return "entities.TbAccessLevel[ tbAccessLevelPK=" + tbAccessLevelPK + " ]";
    }
